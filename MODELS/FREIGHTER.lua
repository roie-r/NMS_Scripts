		...
		---------------- taken from Relight ----------------
			{
				...
				ADD					= ToExml({
				---	left stairs light
					[1] = ScLight({name='pointLight125z',tx=-16.66565, ty=14.0848, tz=-30,8617}),
					[2] = ScLight({name='pointLight125b',tx=-22.66565, ty=11.0848, tz=-25,8617, rx=-135, fov=180, g=0.851, b=0.745}),
					[3] = ScLight({name='pointLight125c',tx=-22.66565, ty=8.0848, tz=-20,8617, g=0.851, b=0.745}),
					[4] = ScLight({name='pointLight125d',tx=-22.66565, ty=5.3848, tz=-15,8617, g=0.851, b=0.745}),
					[5] = ScLight({name='pointLight125e',tx=-22.66565, ty=2.6848, tz=-10,3617, g=0.851, b=0.745}),
					[6] = ScLight({name='pointLight125f',tx=-22.66565, ty=0.0, tz=-4,36167, g=0.851, b=0.745}),
				---	right stairs light
					[7] = ScLight({name='pointLight70z',tx=16.66565, ty=14.0848, tz=-30,8617}),
					[8] = ScLight({name='pointLight70b',tx=22.66565, ty=11.0848, tz=-25,8617, rx=-135, fov=180, g=0.851, b=0.745}),
					[9] = ScLight({name='pointLight70c',tx=22.66565, ty=8.0848, tz=-20,8617, g=0.851, b=0.745}),
					[10] = ScLight({name='pointLight70d',tx=22.66565, ty=5.3848, tz=-15,8617, g=0.851, b=0.745}),
					[11] = ScLight({name='pointLight70e',tx=22.66565, ty=2.6848, tz=-10,3617, g=0.851, b=0.745}),
					[12] = ScLight({name='pointLight70f',tx=22.66565, ty=0.0, tz=-4,36167, g=0.851, b=0.745}),
