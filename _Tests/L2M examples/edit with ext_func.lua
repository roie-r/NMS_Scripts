...
-----------------------------------------------------------------------------------------
--	Simple examples of using ToLua & ToMxml (ToMxml is called by ToMxmlFile)
...
local function ProcessProductTable(exml)
	...
	return ToMxmlFile(gc_prod_file)
end
-----------------------------------------------------------------------------------------
ProcessRawMxml = nil
...
NMS_MOD_DEFINITION_CONTAINER = {
	MOD_FILENAME		= '_TEST L2E edit with ext_func',
	MOD_AUTHOR			= 'lMonk',
	NMS_VERSION			= '6.06',
	MODIFICATIONS 		= {{
	MBIN_CHANGE_TABLE	= {
