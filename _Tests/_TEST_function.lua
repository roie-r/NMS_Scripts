...
local function PathSplit(f)
	-- return {f:match('^(.-)([^\\/]-)$')}
	return {f:match('^(.-)([^\\/]-)(%.[^.]-)$')}
end

local f = 'D:/MODZ_stuff/NoMansSky/AMUMss_Scripts/+Publish/Mech Cust.omizing.lua'
-- local f = 'D:/MODZ_stuff/NoMansSky/AMUMss_Scripts/+Publish/'
-- local f = 'Mech Customizing.lua'
