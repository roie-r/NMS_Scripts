...
NMS_MOD_DEFINITION_CONTAINER = {
	MOD_FILENAME		= '+  TEST 44 generate table sections',
	MOD_AUTHOR			= 'lMonk',
	NMS_VERSION			= '4.7',
	MODIFICATIONS 		= {{
	MBIN_CHANGE_TABLE	= {
	{
		...
		MXML_CHANGE_TABLE	= Add_To_Table
	},
	{
		MBIN_FILE_SOURCE	= 'METADATA/REALITY/TABLES/NMS_REALITY_GCTECHNOLOGYTABLE.MBIN',
		MXML_CHANGE_TABLE	= BuildExmlChangeTable(GetTechCharge, Tech_Charge)
	},
	{
...
AddToExmlChangeTable(NMS_MOD_DEFINITION_CONTAINER.MODIFICATIONS[1].MBIN_CHANGE_TABLE[3].MXML_CHANGE_TABLE, GetIconColor, K_Icons_Color)
