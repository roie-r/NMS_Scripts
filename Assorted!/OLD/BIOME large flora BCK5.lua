...
local function ProcessBiome0(exml, mbin)
...
local function ProcessBiome(exml, mbin)
	...
	-- Add a new ULTRA if the flag is present and return it for editing
...
NMS_MOD_DEFINITION_CONTAINER = {
	MOD_FILENAME 		= '_META large flora',
	MOD_AUTHOR			= 'lMonk',
	NMS_VERSION			= '5.01',
