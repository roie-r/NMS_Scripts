...
NMS_MOD_DEFINITION_CONTAINER = {
	...
	ADD_FILES	= (
		function()
			...
			local T = {}
			-- T[#T+1] = {
				-- FILE_DESTINATION = 'METADATA/REALITY/TABLES/NMS_REALITY_GCTECHNOLOGYTABLE.EXML',
				-- FILE_CONTENT	 = [[<?xml version="1.0" encoding="utf-8"?>
					-- <Data template="GcTechnologyTable">
						-- <Property name="Table">]]..table.concat(gc_tech)..[[</Property>
					-- </Data>]]
			-- }
