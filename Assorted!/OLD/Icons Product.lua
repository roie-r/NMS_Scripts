...
-- }}},
	ADD_FILES	= (
		function()
			local gc_prod = {}
			for id, icon in pairs(prod_icons) do
				gc_prod[#gc_prod+1] = string.format([[
			...
			local T = {}
			T[#T+1] = {
				FILE_DESTINATION = 'METADATA/REALITY/TABLES/NMS_REALITY_GCPRODUCTTABLE.EXML',
				FILE_CONTENT	 = [[<?xml version="1.0" encoding="utf-8"?>
					<Data template="GcProductTable">
						<Property name="Table">]]..table.concat(gc_prod)..[[</Property>
					</Data>]]
			}
