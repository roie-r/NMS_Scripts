...
local mod_desc = [[
  ** Large Props by lMonk **
  ...
  - A property's modifier value=0 will be skipped - You 'zero out' a property.
]]----------------------------------------------------------------------------------
...
local function SetTheScales(biome_objects)
	...
	local mbin_ct = {}
	for _,mbin in pairs(biome_objects) do
		local exml_ct = {}
		local worktags = MergeTables( {scale_tags.globals, GetBiomeScales(mbin.source)} )
		for _,spn in pairs(mbin.spawn) do
			local vct = {}
