...
local function Add_Edit_Remove_Stats(T)
	...
	---	vehicle
		...
		MECH_PROT		= {
			{st='Suit_Protection_Heat'},
			{st='Suit_Protection_Cold'},
			{st='Suit_Protection_Radiation'},
			{st='Suit_Protection_Toxic'},
...
local function Include_In_Category(T)
	for id, cat in pairs({
		...
		MECH_PROT		= {o='Mech',				n='AllVehicles'}
	}) do
		T[#T+1] = {
...
local function Edit_Rgb(T)
	for id, rgb in pairs({
		...
		UT_SMG			= {u='FFEB1FD1'},
		SHIPJUMP_SPEC	= {c='FF095C77'},
		HYPERDRIVE_SPEC	= {c='FF095C77'},
		LAUNCHER_SPEC	= {c='FF095C77'},
		T_BOBBLE_APOLLO	= {c='FF095C77'},
		T_BOBBLE_ART	= {c='FF095C77'},
		T_BOBBLE_ATLAS	= {c='FF095C77'},
		T_BOBBLE_NADA	= {c='FF095C77'},
		T_BOBBLE_NULL	= {c='FF095C77'},
		T_BOBBLE_POLO	= {c='FF095C77'},
		T_SHIP_RAINBOW	= {c='FF095C77'},
		T_SHIP_DARK		= {c='FF095C77'},
		T_SHIP_RED		= {c='FF095C77'},
		T_SHIP_GREEN	= {c='FF095C77'},
		T_SHIP_GOLD		= {c='FF095C77'},
		T_SHIP_PIRATE	= {c='FF095C77'}
	}) do
		if rgb.u then
			T[#T+1] = {
				INTEGER_TO_FLOAT	= 'Force',
				...
				VALUE_CHANGE_TABLE 	= ColorFromHex(rgb.u)
			}
		end
		if rgb.c then
			T[#T+1] = {
				...
				VALUE_CHANGE_TABLE 	= ColorFromHex(rgb.c)
			}
		end
	end
end
