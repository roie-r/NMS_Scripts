...
---	suit
	UP_JETBOOST		= {
		{st='Suit_Jetpack_Tank',				op='*',		mn=1.8,		mx=1.8},
		{st='Suit_Jetpack_Drain',				op='+',		mn=-0.3,	mx=-0.3},
		{st='Suit_Jetpack_Refill',				op='+',		mn=0.5,		mx=0.5},
		{st='Suit_Jetpack_Ignition',			op='+',		mn=0.03,	mx=0.03},
	},
	UP_UNW			= {
...
---	multitool
	UP_SMG			= {
		{st='Weapon_Projectile_Damage',			op='+',		mn=0.2,		mx=0.2},	-- 2, 	3
		{st='Weapon_Projectile_Rate',			op='+',		mn=-0.15,	mx=-0.15},	-- 1.1	1.15
	},
	UP_CANNON		= {
		{st='Weapon_ChargedProjectile_ChargeTime',op='*',	mn=1.2,		mx=1.2},	-- 0.5	0.95
	},
	UP_RAIL			= {
	...
	UP_LASER		= {
		{st='Weapon_Laser_Damage',				mn=1,		mx=1},
		{st='Weapon_Laser_ReloadTime'},
	},
---	vehicle
	UP_EXGUN		= {
		{st='Vehicle_GunDamage',				op='*',		mn=2,		mx=2}, 		-- 30	40
		{st='Vehicle_GunRate'},
	},
	UP_EXOSUBGUN	= {
		{st='Vehicle_GunDamage',				op='*',		mn=2,		mx=2},		-- 30	40
	...
	UP_MCENG		= {
		{st='Vehicle_EngineFuelUse',			op='+',		mn=0.2,		mx=0.2},
		{st='Vehicle_BoostTanks',				op='+',		mn=8,		mx=8},		-- 0.1	0.3
	},
---	ship
	UP_HYPERDRIVE	= {
		{st='Ship_Hyperdrive_JumpDistance',		op='*',		mn=2.4,		mx=2.4},
		{st='Ship_Hyperdrive_JumpsPerCell',		op='*',		mn=0.4,		mx=0.4},
	},
	AP_HYPERDRIVE	= {
		{st='Ship_Hyperdrive_JumpDistance',		op='*',		mn=2.4,		mx=2.4},
		{st='Ship_Hyperdrive_JumpsPerCell',		op='*',		mn=0.4,		mx=0.4},
	...
	AP_PULSEDRIVE	= {
		...
		{st='Ship_Maneuverability',				op='+',		mn=0.07,	mx=0.07},	-- 1.0065
	},
---	freighter
	UT_FR_HYP_NAME	= {
		{st='Freighter_Hyperdrive_JumpDistance',op='*',		mn=10,		mx=10},
		{st='Freighter_Hyperdrive_JumpsPerCell',op='*',		mn=0.4,		mx=0.4}
	},
}
local ECT = {{
	SKW			 = {},
