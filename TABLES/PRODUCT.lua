...
local icon_bg_color = {
	{'UI_FUELPROD3_NAME',			'8a4242ff'}, -- Carbon Crystal
	{'UI_LANDPROD3_NAME',			'8a4242ff'}, -- Rare Metal Element
	{'UI_CAVEPROD3_NAME',			'8a4242ff'}, -- TetraCobalt
	{'UI_CATAPROD3_NAME',			'8a4242ff'}, -- Chloride Lattice
	{'UI_WATERPROD3_NAME',			'8a4242ff'}, -- Destablised Sodium
	{'UI_OXYPROD3_NAME',			'8a4242ff'}, -- Superoxide Crystal
	...
	{'UI_TECHMOD_NAME',				'1a2733ff'}, -- Wiring Loom
...
local prod_requirements = {
	...
	---	cargo_bulkhead
		id	 = 'FREI_INV_TOKEN',
		cost = 8,
		{'CASING', 		40,		I_.PRD},	-- plating
		{'COMPOUND6',	3,		I_.PRD},	-- cryo pump
		{'FARMPROD5',	5,		I_.PRD}		-- poly fibre
	},{
	---	wiring loom
		id   = 'TECH_COMP',
