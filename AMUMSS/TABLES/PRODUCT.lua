...
Req_Substance = {
	dat = {
		...
		'C_DOOR', 'C_DOOR_H', 'C_GDOOR', 'C_GDOOR_D', 'C_DOORWINDOW', 'C_DOORWINDOW', 'C_FLOOR',
		'C_TRIFLOOR', 'C_TRIFLOOR_Q', 'C_GFLOOR', 'C_FLOOR_Q', 'C_RAMP', 'C_RAMP', 'C_RAMP_H', 'C_RAMP_H',
		'C_ROOF', 'C_ROOF_M', 'C_ROOF_C', 'C_ROOF_IC', 'C_ROOF_IC', 'C_ARCH', 'C_ARCH_H',
		...
		'M_TRIFLOOR_Q', 'M_GFLOOR', 'M_FLOOR_Q', 'M_RAMP', 'M_RAMP_H', 'M_ROOF', 'M_ROOF_M', 'M_ROOF_M',
		'M_ROOF_C', 'M_ROOF_C', 'M_ROOF_IC', 'M_ROOF_IC', 'M_ARCH', 'M_ARCH_H',
		...
		'S_DOORWINT0', 'S_GDOOR', 'S_GDOORB0', 'S_GDOORM0', 'S_GDOORT0', 'S_ARCH', 'S_ARCHB', 'S_ARCHM',
		'S_ARCHT', 'S_ARCH_H', 'S_ARCHB_H', 'S_ARCHM_H', 'S_ARCHT_H', 'S_RAMP_Q_TOP',
		...
		'F_ROOF8', 'F_ROOF_M', 'F_ROOF_C', 'F_ROOF_IC', 'F_CHEV_WALL', 'F_CHEV_DOOR', 'F_CHEV_WALL_H_C',
		'F_CHEV_WIN0', 'F_CHEV_WIN1', 'F_CHEV_WIN2', 'F_ROOF_M_Q', 'F_ROOF_E_Q', 'F_ROOF_M_CAP',
		'F_ROOF_E_CAP', 'F_DOOR_H', 'F_DOORB0_H', 'F_DOORM0_H', 'F_DOORT0_H', 'F_DOORWINDOW', 'F_DOORWINB0',
		'F_DOORWINM0', 'F_DOORWINT0', 'F_GDOOR', 'F_GDOORB0', 'F_GDOORM0', 'F_GDOORT0', 'F_ARCH',
		'F_ARCHB', 'F_ARCHM', 'F_ARCHT', 'F_ARCH_H', 'F_ARCHB_H', 'F_ARCHM_H', 'F_ARCHT_H', 'F_RAMP_Q_TOP',
 	},
	Get = function(x)
		local S = {C='LAND2', M='LAND3', S='LAND2', F='LAND3'}
		return {
