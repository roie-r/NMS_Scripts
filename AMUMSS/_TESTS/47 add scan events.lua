...
NMS_MOD_DEFINITION_CONTAINER	= {
	...
	MOD_DESCRIPTION		= [[
							...
							area, facilitating easy base construction. ]],
	MODIFICATIONS		= {{
	MBIN_CHANGE_TABLE	= {
	-- {
	...
	-- },
	{
		...
		EXML_CHANGE_TABLE	= {
			{
				SPECIAL_KEY_WORDS	= {'Name', 'RADIOTOWER'},
				REPLACE_TYPE		= 'ADDAFTERSECTION',
				ADD					= GetScanEvent('Base')
			}
		}
	},
	{
		...
		EXML_CHANGE_TABLE	= {
			{
				...
				REPLACE_TYPE		= 'ADDAFTERSECTION',
				ADD					= GetScanEvent('Plaque') .. GetScanEvent('Terminal')
			}
		}
	},
	{
