--[[┎────────────────────────────────────────────────────────
	...
	┃ Add 'harvet all' function to large planter
────┸────────────────────────────────────────────────────--]]
function AddIteractionEntityEXML(harvet_radius)
	return '<?xml ' .. [[
								...
								<Property value="GcActionTrigger.xml">
									...
									<Property name="Action">
										<Property value="GcHarvestPlantAction.xml">
											<Property name="Radius" value="]] .. harvet_radius .. [[" />
										</Property>
										<Property value="GcPlayAnimAction.xml">
											<Property name="Anim" value="ON" />
										</Property>
...
function AddObjectInteractionNode(Object_Path)
	return [[
...
Base_Parts = 'MODELS\PLANETS\BIOMES\COMMON\BUILDINGS\PARTS\BUILDABLEPARTS\\'
