...
function AddNewScanEvent(name)
	local BuildingClass = name
	if name == 'LIBRARY' then BuildingClass = 'LargeBuilding' end
	return [[
...
function AddNewScanEvent_OLD(name)
	local class = name
	if name == 'LIBRARY' then class = 'LargeBuilding' end
	return [[
	<Property value="GcScanEventData.xml">
		<Property name="Name" value="]] .. string.upper(name) .. [[" />
		<Property name="ForceInteraction" value="" />
		...
		<Property name="BuildingType" value="BuildingClass" />
		<Property name="BuildingClass" value="GcBuildingClassification.xml">
			<Property name="BuildingClass" value="]] .. class .. [[" />
		</Property>
